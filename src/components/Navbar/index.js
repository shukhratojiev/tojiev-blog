...
const Navbar = () => {
    ...
    const showSidebar = () => setStyle("sidebar_2");
    const hideSidebar = () => setStyle("sidebar_1");
    ...
    return ( 
        <nav className="navbar">
            <ul ref={sideNavRef} className={style}>
                ...
                <li onClick={hideSidebar} className="link"><Link className="item" to="/blogs">Blog</Link></li>
                <li onClick={hideSidebar} className="link"><Link className="item" to="/projects">Projects</Link></li>
            </ul>
            <ul className="list">
